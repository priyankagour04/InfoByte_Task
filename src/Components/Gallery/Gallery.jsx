        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap ">
            ...
            <div className="w-full md:w-1/4">
              <img src={outimg} className="w-full h-96 object-cover " />
            </div>
            ...
            <div className="w-full md:w-3/4 flex flex-col">
              <div className="flex flex-wrap">
                ...
                <div className="w-full sm:w-1/2 lg:w-2/4">
                  <img src={ayodhya} className="w-full h-48 object-cover " />
                </div>
                <div className="w-full sm:w-1/4 lg:w-1/4">
                  <img src={large} className="w-full h-48 object-cover " />
                </div>
                <div className="w-full sm:w-1/4 lg:w-1/4">
                  <img src={palash} className="w-full h-48 object-cover " />
                </div>
              </div>
              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-full sm:w-1/2 lg:w-1/4">
                  <img src={small} className="w-full h-48 object-cover " />
                </div>
                <div className="w-full sm:w-1/4 lg:w-2/4">
                  <img src={baranti} className="w-full h-48 object-cover " />
                </div>
                <div className="w-full sm:w-1/4 lg:w-1/4">
                  <img src={recep} className="w-full h-48 object-cover" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4">
              <img src={flower} className="w-full h-48 object-cover" />
            </div>
            <div className="w-full md:w-2/4">
              <img src={room} className="w-full h-48 object-cover" />
            </div>
            <div className="w-full md:w-1/4">
              <img src={mithonDam} className="w-full h-48 object-cover" />
            </div>
          </div>
        </div>
      </div>
